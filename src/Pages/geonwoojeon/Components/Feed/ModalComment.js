...
class ModalComment extends React.Component {
  ...
  render() {
    return (
      <div className="modal" onClick={this.props.isCheck}>
        <button className="close" onClick={this.props.isCheck}>
          &times;
        </button>
        <div className="modal-container" onClick={e => e.stopPropagation()}>
          ...
          <div className="modal-right">
            ...
            <div className="modal-right-comment">
              ...
              {this.props.pastCommentList.map((comment, index) => {
                return (
                  <PastMoreComment
                    key={index}
                ...
                <div className="article-bottom-icon">
                  <div className="article-bottom-icon-left">
                    <button
                      ...
                      onClick={this.props.clickHeart}
                    >
                      <svg
                        aria-label="좋아요"
                        fill={this.props.mode ? 'black' : 'red'}
                        height="24"
                        viewBox="0 0 48 48"
                        width="24"
                      >
                  ...
                  <Link to="/">
                    ...
                    <span>
                      ...
                      {this.props.mode
                        ...
                        : Number(this.props.likeCount) + 1}
                    </span>
                    개
                  </Link>
                </div>
                <div className="article-bottom-past-time">
                  {this.props.pastTime}
                </div>
                <div className="article-bottom-input">
                  ...
                  <form>
                    ...
                    <button
                      ...
                      disabled={this.props.comment.length < 1}
